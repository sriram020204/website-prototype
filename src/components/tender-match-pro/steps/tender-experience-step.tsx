...
import { Textarea } from '@/components/ui/textarea'; // Keep if other fields use it, or remove if not.
...
const TENDER_TYPE_OPTIONS = [
  ...
  "Rail Infrastructure Development Contracts",
  ...
  "Procurement of IT Hardware and Accessories",
  "Supply of Vehicles and Automotive Components",
  "Supply of Electrical Goods and Components",
  ...
  "Manpower Supply and Staffing Services",
  ...
  "Technical Feasibility Study Services",
  "Social Impact Assessment Consultancy",
  // Project-Based and Turnkey Tenders
  "Engineering, Procurement and Construction Contracts",
  "Turnkey Project Implementation Contracts",
  "Design, Build, Operate and Transfer Contracts",
  "Design and Build Infrastructure Projects",
  "Public-Private Partnership Infrastructure Projects",
  "Build-Operate-Transfer Project Contracts",
  "Build-Own-Operate Infrastructure Models",
  // Information Technology and Digital Tenders
  "Software Development Projects",
  "Website and Mobile Application Development",
  "System Integration and Implementation Services",
  "Information Technology Infrastructure Setup",
  "Enterprise Resource Planning System Deployment",
  ...
  "Maintenance of IT Systems and Networks",
  "Maintenance of Building Infrastructure",
  "Electrical and Mechanical Maintenance Services",
  // Green and Sustainability-Focused Tenders
  "Renewable Energy System Installation (Solar, Wind, etc.)",
  ...
  "Green Building Certification and Consultancy",
  // Financial and Administrative Tenders
  ...
  "Pilot Study and Field Testing Projects"
].sort();
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription id="tenderTypesHandled-description">
                Select the types of tenders your company has experience with, or type to add custom ones.
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
